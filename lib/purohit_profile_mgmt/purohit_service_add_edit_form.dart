...
import 'package:pujapurohitmanagement/purohit_profile_mgmt/reusable_widgets.dart';
...
class _PurohitServiceAddAndEditState extends State<PurohitServiceAddAndEdit> {
  ...
  void initState() {
    if (widget.documentSnapshot != null) {
      price = widget.documentSnapshot!.data()!["puja_ceremony_price"];
      time = widget.documentSnapshot!.data()!["puja_ceremony_time"];
      additionalDetails =
          widget.documentSnapshot!.data()!["puja_ceremony_details"] == null
              ? ""
              : widget.documentSnapshot!.data()!["puja_ceremony_details"];
    } else {
      price = widget.price == null ? 500 : widget.price;
      time = widget.time == null ? "2 Hours" : widget.time;
    }
    super.initState();
  }
