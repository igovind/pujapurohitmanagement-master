...
class PujaEditForm extends StatefulWidget {
  final languageCode;
  ...
  @override
  _PujaEditFormState createState() => _PujaEditFormState();
}

class _PujaEditFormState extends State<PujaEditForm> {
          ...
          child: ListTile(
            trailing: Container(
              ...
              child: TextFormField(
                ...
                onChanged: (value) {
                 setState(() {
                   newMap.addAll({"${element["id"]}": "$value"});
        ...
        child: Form(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                Image.network(
                  _image.isEmpty ? widget.initialDetails["image"] : _image,
