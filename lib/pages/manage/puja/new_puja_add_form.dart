...
class PujaAddForm extends StatefulWidget {
  final languageCode;
  ...
  @override
  _PujaAddFormState createState() => _PujaAddFormState();
}

class _PujaAddFormState extends State<PujaAddForm> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
              onPressed: () {
                print("UUUU_______$newMap");
                if (_aFormKey.currentState!.validate() &&
                    selectedSamagriIndex["Arunachal Pradesh"]!.isNotEmpty) {
                  ...
                  // print(selectedSamagriIndex);
                  // print("KKKKKK---- $quantityIdMap");
                  print("}}}}}}}------- $newMap");
                } else {
                  if (selectedSamagriIndex.isEmpty) {
                    showDialog(
                        context: context,
                        builder: (_) => AlertDialog(
                              title: Text("Please add samagries"),
                            ));
                  }
                }
              },
